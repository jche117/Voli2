...
from app.modules.users.models import User, Role, user_roles
...
from app.modules.task_templates.models import *
...
def get_url():
    return os.getenv("DATABASE_URL", "postgresql://user:password@localhost/db")
